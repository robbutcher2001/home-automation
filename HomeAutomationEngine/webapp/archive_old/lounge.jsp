...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="resources/js/loungeHandler.js"><!-- --></script>
	</head>
	<body class="loungePage">
		<div class="text-center statusBar">No error</div>
		<button id="fullOn" class="text-center floatCenterScreen">Full On</button>
		<button id="filmMode" class="text-center floatCenterScreen">Film/TV Mode</button>
